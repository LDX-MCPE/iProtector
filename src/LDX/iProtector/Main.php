...
class Main extends PluginBase implements Listener {
                    ...
                    if (isset($args[1])) {
                        if (isset($this->pos1[$n]) && isset($this->pos2[$n])) {
                            if (!isset($this->areas[strtolower($args[1])])) {
                                $area = new Area(strtolower($args[1]), array("edit" => true, "god" => false, "touch" => true, "hunger" => false), array($this->pos1[$n]->getX(), $this->pos1[$n]->getY(), $this->pos1[$n]->getZ()), array($this->pos2[$n]->getX(), $this->pos2[$n]->getY(), $this->pos2[$n]->getZ()), $p->getLevel()->getName(), array($n), $this);
                                $this->saveAreas();
                                unset($this->pos1[$n]);
                                unset($this->pos2[$n]);
                                $o = "Area created!";
                        ...
                        if (isset($this->areas[strtolower($args[1])])) {
                            ...
                            if (isset($args[2])) {
                                if (isset($area->flags[strtolower($args[2])])) {
                                    ...
                                    $o = "Flag not found. (Flags: edit, god, touch, hunger)";
                                }
                            } else {
                                $o = "Please specify a flag. (Flags: edit, god, touch, hunger)";
                            }
                        } else {
    ...
    public function canGetHungry($p) {
        $o = true;
        $g = (isset($this->levels[$p->getLevel()->getName()]) ? $this->levels[$p->getLevel()->getName()]["Hunger"] : $this->hunger);
        if ($g) {
            $o = false;
        }
        foreach ($this->areas as $area) {
